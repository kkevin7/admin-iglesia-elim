      ...
      <Card className="shadow border-0 card">
        <CardActionArea>
          ...
          <CardContent>
            ...
            <div className="col-12">
              <div className="row">
                <div className={` col-12 col-md-9 mx-auto ${classExistencia}`}>
                  <Typography
                ...
                <div
                  className={`col-12 col-md-9 mx-auto mt-2 badge text-uppercase text-white bg-cyan`}
                >
                  <Typography
                    className="text-white"
                    variant="body2"
        ...
        <CardActions>
          <Button
            size="small"
            variant="contained"
            onClick={() => handleRedirectDetalle(producto.id)}
            color="primary"
          >
